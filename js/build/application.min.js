...
},b.prototype.updateArrows=function(){var a=this;a.options.arrows===!0&&a.options.infinite!==!0&&a.slideCount>a.options.slidesToShow&&(a.$prevArrow.removeClass("slick-disabled"),a.$nextArrow.removeClass("slick-disabled"),0===a.currentSlide?(a.$prevArrow.addClass("slick-disabled"),a.$nextArrow.removeClass("slick-disabled")):a.currentSlide>=a.slideCount-a.options.slidesToShow&&(a.$nextArrow.addClass("slick-disabled"),a.$prevArrow.removeClass("slick-disabled")))},b.prototype.updateDots=function(){var a=this;null!==a.$dots&&(a.$dots.find("li").removeClass("slick-active"),a.$dots.find("li").eq(a.currentSlide/a.options.slidesToScroll).addClass("slick-active"))},a.fn.slick=function(a){var c=this;return c.each(function(c,d){d.slick=new b(d,a)})},a.fn.slickAdd=function(a,b,c){var d=this;return d.each(function(d,e){e.slick.addSlide(a,b,c)})},a.fn.slickCurrentSlide=function(){var a=this;return a.get(0).slick.getCurrent()},a.fn.slickFilter=function(a){var b=this;return b.each(function(b,c){c.slick.filterSlides(a)})},a.fn.slickGoTo=function(a){var b=this;return b.each(function(b,c){c.slick.slideHandler(a)})},a.fn.slickNext=function(){var a=this;return a.each(function(a,b){b.slick.changeSlide({data:{message:"next"}})})},a.fn.slickPause=function(){var a=this;return a.each(function(a,b){b.slick.autoPlayClear(),b.slick.paused=!0})},a.fn.slickPlay=function(){var a=this;return a.each(function(a,b){b.slick.paused=!1,b.slick.autoPlay()})},a.fn.slickPrev=function(){var a=this;return a.each(function(a,b){b.slick.changeSlide({data:{message:"previous"}})})},a.fn.slickRemove=function(a,b){var c=this;return c.each(function(c,d){d.slick.removeSlide(a,b)})},a.fn.slickSetOption=function(a,b,c){var d=this;return d.each(function(d,e){e.slick.options[a]=b,c===!0&&(e.slick.unload(),e.slick.reinit())})},a.fn.slickUnfilter=function(){var a=this;return a.each(function(a,b){b.slick.unfilterSlides()})},a.fn.unslick=function(){var a=this;return a.each(function(a,b){b.slick.destroy()})}}),$(function(){function a(a){"enable"==a?($("#select2-drop").addClass("active"),$("#select2-drop .search-tag").removeClass("visuallyhidden"),$("#search-select .search-tag").removeAttr("disabled")):($("#select2-drop").removeClass("active"),$("#select2-drop .search-tag").addClass("visuallyhidden"),$("#search-select .search-tag").prop("disabled",!0))}function b(){setTimeout(function(){0===$("#s2id_autogen1_search").val().length&&a("disable")},10)}function c(){h===!1?(f.css({marginTop:-g}),f.show(),f.transition({marginTop:0}),h=!0):f.transition({marginTop:-g},function(){f.hide(),h=!1})}$.support.pjax&&($.pjax.defaults.timeout=5e3),$(document).pjax("a","#pjax-container"),$(document).on("pjax:start",function(){$("#pjax-container").addClass("pjax-transition")}),$(document).on("pjax:end",function(){$("#pjax-container").removeClass("pjax-transition");var a=$("#pjax-page-title").html();$("#select2-chosen-1").html(a+'<span class="search-caret"></span>')}),$(document).on("pjax:timeout, pjax:error",function(){});var d,e=function(){$("#pjax-container").prepend('<div class="loader">Loading...</div>'),$(".loader").fadeIn()};$(document).on("pjax:send",function(){var a=2e3;d=window.setTimeout(e,a)}),$(document).on("pjax:complete",function(){picturefill(),window.clearTimeout(d),$(".loader").fadeOut(function(){$(".loader").remove()})}),$(".search-nav").fadeIn(100),$("#search-select").select2({matcher:function(a,b){return 0===b.toUpperCase().indexOf(a.toUpperCase())}}).on("select2-opening",function(){a("disable")}).on("select2-selecting",function(a){var b=a.val;$("#wp-search-input, #wp-search-input-single-images").val(b),$(document).one("submit","#wp-search-form, #wp-search-form-single-images",function(a){$.pjax.submit(a,"#pjax-container")}),"image-set-search-tag"==a.object.css?$("#wp-search-form").submit():$("#wp-search-form-single-images").submit()}),$(document).on("keyup","#s2id_autogen1_search",function(){a($(this).val().length?"enable":"disable"),b()}).on("keydown","#s2id_autogen1_search",function(c){8==c.which?1==$(this).val().length&&a("disable"):c.which<=90&&c.which>=48&&a("enable"),b()}),$("#select2-chosen-1").append('<span class="search-caret"></span>');var f=$("#info-wrapper"),g=f.outerHeight(!0),h=!1;$("#info-button").click(function(){c()}),$("#info-wrapper-close").click(function(){c()}),$(document).on("click",".image-viewer-close",function(){$(".image-set-open").length&&$("html, body").animate({scrollTop:$(".image-set-open").offset().top-.1*$(window).height()}),destroyImageViewer()}),$(window).resize(function(){calculateColumnsInRow(".image-set"),calculateColumnsInRow(".single-image")})}),$(document).on("page:load ready pjax:end",function(){function a(a,b,c){function d(a,b){$(".image-viewer-slide-count").html(a+"/"+b)}var e='<div class="image-viewer"><div class="image-viewer-slide-count"></div><div class="image-viewer-close"></div><div class="image-viewer-open-indicator"></div><div class="image-viewer-slide-container"></div></div>',f=.9,g=1-f,h=$(window).height()*g,i=36,j=($(window).height()-h)*f+i;$(window).width()<760&&(j+=40),"above"==b?a.before(e):a.after(e),$(c).each(function(){var a=$(this).attr("data-image-caption").length?'<div class="caption">'+$(this).attr("data-image-caption")+"</div>":"",b=$(this).attr("data-image-caption").length?' class="has-caption"':"",c=$(this).attr("data-image-url"),d=$(this).attr("data-image-url-2x"),e=$(this).attr("data-image-url-mobile"),f=$(this).attr("data-image-url-mobile-2x");$(".image-viewer-slide-container").append("<div"+b+'><picture style="display: none;"><!--[if IE 9]><video style="display: none;"><![endif]--><source srcset="'+e+", "+f+' 2x" media="(max-width: 800px)"><source srcset="'+c+", "+d+' 2x"><!--[if IE 9]></video><![endif]--><img srcset="'+c+", "+d+' 2x"></picture>'+a+"</div>")}),$(".image-viewer-slide-container picture").show(),picturefill(),$(".image-viewer").addClass("open").css({height:j});var k=$(".image-viewer").offset().top-h;$("html, body").animate({scrollTop:k},400,"swing");var l=1,m=0;$(".image-viewer-slide-container").slick({onInit:function(a){m=a.slideCount,l=a.currentSlide+1,d(l,m)},onAfterChange:function(a){l=a.currentSlide+1,d(l,m)}})}calculateColumnsInRow(".image-set"),$(".image-set-info-wrapper").click(function(){var b=$(this).closest(".image-set"),c=b.nextAll(".new-image-set-row").first(),d=$(this).closest(".image-set").children(),e=d.clone().toArray();b.hasClass("image-set-open")||(destroyImageViewer(),b.addClass("image-set-open"),0===c.length?(c=b.nextAll(".image-set").last(),0===c.length&&(c=b),a(c,"below",e)):a(c,"above",e));var f=b.offset().left,g=$(".image-viewer").offset().left,h=b.find("img").width(),i=f-g+h/2;$(".image-viewer-open-indicator").css({left:i})}),calculateColumnsInRow(".single-image"),$(".single-image").click(function(){var b=$(this),c=$(this).nextAll(".new-image-set-row").first(),d=[$(this).find("img")];$(this).hasClass("image-set-open")||(destroyImageViewer(),$(this).addClass("image-set-open"),0===c.length?(c=b.nextAll(".single-image").last(),0===c.length&&(c=b),a(c,"below",d)):a(c,"above",d),$(".image-viewer").addClass("image-viewer-single-image"));var e=b.offset().left,f=$(".image-viewer").offset().left,g=b.find("img").width(),h=e-f+g/2;$(".image-viewer-open-indicator").css({left:h})})});